        ...
        <div className="main-middle-section">
          <div className="container" >
            <div className="col-md-12">
              ...
              <h3 className="min-header">У нас вы можете подобрать и заказать запчасти</h3>
              <h3 className="min-header">У нас на станции только новое оборудование</h3>
              <h3 className="min-header">Стоимость норма часа 31 р.</h3>
            </div>
          </div>
        </div>
